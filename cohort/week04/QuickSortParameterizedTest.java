...
public class QuickSortParameterizedTest {
    ...
    public static Collection<Object[]> parameters() {
        return Arrays.asList(new Object[][] {{new int[] {1}, new int[] {1}},
                {new int[] {1, 2, 3}, new int[] {1, 2, 3}},
                {new int[] {1, 2, 3}, new int[] {3, 2, 1}},
                {new int[] {1, 3, 6, 10}, new int[] {10, 3, 1, 6}},
                {new int[] {-2, -2, 0, 9, 9, 16}, new int[] {0, -2, -2, 9, 16, 9}},
                {new int[] {-865, -863, -842, -721, -453, -314, -309, 13, 111, 274, 289, 297, 513,
                        661, 932},
