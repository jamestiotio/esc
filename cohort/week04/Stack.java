...
public class Stack<E> extends Vector<E> {
    ...
    // Pre-condition: True
    // Post-condition: The top element in the stack is item and all the remaining elements remain
    // unchanged. if the capacity of stack equals to the size of the stack before pushing, increase
    ...
    // Pre-condition: True
    // Post-condition: If the stack is empty, throws an exception; otherwise, remove the top element
    // in the stack and leave the rest unchanged.
