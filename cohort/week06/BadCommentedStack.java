...
public class BadCommentedStack<E> extends Vector<E> {
    ...
    // precondition: true
    // postcondition: the top element in the stack is item and all the remaining elements remain
    ...
    // precondition: true
    // postcondition: if the stack is empty, throws an exception; otherwise, remove the top element
