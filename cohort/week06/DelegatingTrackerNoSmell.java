...
public class DelegatingTrackerNoSmell {
    private final ConcurrentMap<String, Point> locations;

    public DelegatingTrackerNoSmell(Map<String, Point> locations) {
...
// sudiptac: this class is not doing much, without more responsibility, this class may become a data
// class
class Point {
    private int x, y;
    ...
    // sudiptac: put more responsibilities on the point class, such as transformations on points, if
    // needed,
