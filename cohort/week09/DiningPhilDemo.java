    ...
    public void run() {
        ...
        try {
            while (true) {
                ...
                left.pickup();
                Thread.sleep(3000); // This demo line ensures that deadlock will happen (i.e., every philosopher will get their left fork but not their right fork since no more forks are left on the table)
