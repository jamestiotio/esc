...
class VoteCounter extends Thread {
    ...
    public void run() {
        ...
        /*
         * Question 1: what if the following code is used instead? synchronized (this) { while
         * (true) { if (votes != null) { break; } } }
         */

        /*
         * Fix synchronized (this) { //mind the order of synchronized and while while (votes ==
         * null) { //Q: why a while loop is needed here? try { wait(); } catch (InterruptedException
         * e) { // TODO Auto-generated catch block e.printStackTrace(); } } }
         */

        /*
         * Question 2: what if the following code is used instead? while (votes == null) {
         * synchronized (this) { try { wait(); } catch (InterruptedException e) { // TODO
