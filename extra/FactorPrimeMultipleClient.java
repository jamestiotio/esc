...
public class FactorPrimeMultipleClient {
    public static void main(String[] args) throws Exception {
        ...
        do {
            ...
            for (BigInteger i = borderValue1; i.compareTo(borderValue2) <= 0; i =
                ...
                if (receivedSemiPrime.remainder(i).compareTo(zero) == 0) {
                    ...
                    System.out.println("The prime factors are " + i + " and " + anotherFactor + ".");
                    break;
                }
            }
