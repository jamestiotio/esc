...
public class FactorPrimeMultipleServer {
            ...
            // if more than one client connected
                ...
                for (int i = 0; i < sockets.size(); i++) {
                    ...
                    // the last client
                        ...
                        outChannels.get(i).println(inputSemiPrime);
                        outChannels.get(i).println(
                                borderValue.multiply(BigInteger.valueOf(sockets.size() - 2)));
                        outChannels.get(i).println(inputSemiPrime
                                .subtract(inputSemiPrime.subtract(BigInteger.valueOf(1))));
                        outChannels.get(i).flush();
                    }
                    // the ones in the middle
                        ...
                        outChannels.get(i).println(inputSemiPrime
                                .subtract(inputSemiPrime.subtract(BigInteger.valueOf(i + 1))));
                        outChannels.get(i).flush();
                    }
                }
            }
