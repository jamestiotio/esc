...
// Subscriber type class, sends locally generated updates to the publisher and receives global
// updates.
class User {
    String username;
    ...
    void removePost(int id) {
        System.out.println("Post " + Integer.toHexString(id) + " containing '"
                + subscription.getPost(id).getPostContent() + "' removed\n");
    ...
    void editPost(int id, String content) {
        ...
        System.out.println(username + " edited post " + Integer.toHexString(replacement.getID())
                + " to: " + replacement.getPostContent() + "\n");
    }
    ...
    void unsubscribe(int id) {
        System.out
                .println(username + " unsubscribed from post id " + Integer.toHexString(id) + "\n");
...
class Post {
    ...
    void addChildComment(Post comment) {
        childComments.add(comment);
    }

    void removeChildComment(Post comment) {
        childComments.remove(comment);
    }

    void showCommentStack(int depth) {
        ++depth;
        String comment = "(post_id: " + Integer.toHexString(id) + ") " + timestamp + " "
