...
public class FileTransferServerMultipleClients {
    public static void main(String[] args) throws Exception {
        ...
        while (true) {
            try {
                ...
                inChannels
                        .add(new BufferedReader(new InputStreamReader(newSocket.getInputStream())));
                outChannels.add(new PrintWriter(newSocket.getOutputStream(), true));
            } catch (java.net.SocketTimeoutException e) {
                System.out.println(
                        "Timed out, server closed for new connections. Now start file transferring!");
                break;
            }
        }
