...
public class MultiProcessSemiPrimeServer {
    public static void main(String[] args) throws Exception {
        ...
        ObjectOutputStream out3 = new ObjectOutputStream(clientSocket3.getOutputStream());
        ...
        BufferedReader in1 =
                new BufferedReader(new InputStreamReader(clientSocket1.getInputStream()));
        BufferedReader in2 =
                new BufferedReader(new InputStreamReader(clientSocket2.getInputStream()));
        BufferedReader in3 =
                new BufferedReader(new InputStreamReader(clientSocket3.getInputStream()));
        ...
        for (int i = 1; i < 3; i++) {
            lowers[i] =
                    BigInteger.valueOf(i).multiply(inputSemiPrime.divide(BigInteger.valueOf(3)));
        }
        // assign values for the uppers
        uppers[2] = inputSemiPrime.subtract(one);
        for (int i = 0; i < 2; i++) {
            uppers[i] = BigInteger.valueOf(i + 1)
                    .multiply(inputSemiPrime.divide(BigInteger.valueOf(3)));
        }
